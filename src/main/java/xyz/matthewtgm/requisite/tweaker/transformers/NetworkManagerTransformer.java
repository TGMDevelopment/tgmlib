        ...
        for (MethodNode method : classNode.methods) {
            if (QuickASM.nameMatches(method,
                ...
                QuickASM.insertBefore(method, method.instructions.getFirst(), list -> {
                    ...
                    list.add(new MethodInsnNode(INVOKESTATIC, "xyz/matthewtgm/requisite/tweaker/hooks/NetworkManagerHook", "callEvent", "(" + EnumTransformerClasses.NetworkManager.getName() + EnumTransformerClasses.Packet.getName() + ")V", false));
                });
            }
        }
    }
