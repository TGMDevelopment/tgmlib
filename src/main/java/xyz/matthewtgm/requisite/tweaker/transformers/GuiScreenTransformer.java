...
import xyz.matthewtgm.requisite.tweaker.hooks.RequisiteGuiScreenAccessor;
import xyz.matthewtgm.requisite.tweaker.hooks.RequisiteGuiScreenInvoker;
...
public class GuiScreenTransformer implements ITransformer {
    ...
    public void transform(ClassNode classNode, String name) {
        QuickASM.convertAccessor(classNode, RequisiteGuiScreenAccessor.class);
        ...
        QuickASM.convertInvoker(classNode, RequisiteGuiScreenInvoker.class);
