...
import xyz.matthewtgm.requisite.tweaker.hooks.RequisitePositionedSoundAccessor;
...
public class PositionedSoundTransformer implements ITransformer {
    ...
    public void transform(ClassNode classNode, String name) {
        QuickASM.convertAccessor(classNode, RequisitePositionedSoundAccessor.class);
