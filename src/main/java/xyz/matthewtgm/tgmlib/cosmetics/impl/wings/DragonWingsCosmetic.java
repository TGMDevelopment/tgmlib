...
package xyz.matthewtgm.tgmlib.cosmetics.impl.wings;

import net.minecraft.util.ResourceLocation;
import xyz.matthewtgm.tgmlib.cosmetics.BaseWingsCosmetic;
...
public class DragonWingsCosmetic extends BaseWingsCosmetic {
    ...
    public DragonWingsCosmetic() {
        super("Dragon Wings", "DRAGON_WINGS");
    }
